...
<body>
	...
	<script type="text/javascript">
		...
		graphv[0] = ['&bull; Perbaikan Rumus PPN, Lap. Penjualan & Pembalian', 5];
		graphv[1] = ['&bull; RAP TEMEF', 35];
		...
		graphv[6] = ['&bull; Pembuatan Menu Pergerakan Bahan Jadi (Stok) & Evaluasi', 100,];
